...
<div>
    ...
    <form method="POST" action="" id="signDocForm" onsubmit="return docs.sendSignDocForm(1); return false;">
        ...
        <div class="form-check mb-2">
            ...
            <div class="form-panel<?php if($page_option == 1) { echo ' showed'; } ?>" id="formPanel1">
            </div>
        </div>
        <div class="form-check mb-2">
            ...
            <div class="form-panel<?php if($page_option == 2) { echo ' showed'; } ?>" id="formPanel2">
            </div>
        </div>
            ...
            <div class="form-panel<?php if($page_option == 3) { echo ' showed'; } ?>" id="formPanel3">
                <div class="col-lg-8 ms-1 mt-1 mb-0">
                    <div class="form-group">
                        <label for="signText"><?php echo $tr['SIGN.PAGES.CUST.LABEL']; ?> :</label>
                        <input type="text" name="sign_pages" id="signPages" maxlength="50" class="form-control" aria-describedby="signTextHelp" required="required" onfocus="$(this).removeClass('is-invalid'); $('#globalError').empty();" placeholder="<?php echo $tr['SIGN.PAGES.CUST.PLACEHOLDER']; ?>" value="<?php echo $sign_pages; ?>" />
                          <div class="invalid-feedback"><?php echo $tr['SIGN.PAGES.CUST.INVALID']; ?></div>
                     </div>
                </div>
            </div>
        </div>
