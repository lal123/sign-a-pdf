                <p><?php echo $tr['DOCS.SIGN.INTRO']; ?> :</p>
                <form method="POST" action="" id="signDocForm" onsubmit="return docs.sendSignDocForm(); return false;">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="sign_option" value="1" id="signOption1">
                        <label class="form-check-label" for="radioDefault1">
                            Default radio
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="sign_option" value="2" id="signOption2" disabled>
                        <label class="form-check-label" for="radioDisabled">
                            Disabled radio
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="sign_option" value="3" id="signOption3" checked>
                        ...
                        <div class="col-lg-8 ms-0 mt-1 mb-0" id="globalError" style="color: red;"><?php echo $arr['err_msg']; ?></div>
                    </div>
                </form>
