...
$tr =[
	...
	'HOME.INTRO'			=> '<a class="common" href="%%account_link%%">Create an account</a>, and you will retrieve easily your documents and your signatures',
	...
	'DOCS.SIGN.STEP3.INTRO'			=> 'Choose on which pages the signatures has to be added',
	...
	'SIGN.PAGES.CUST.INVITE'		=> "A choice of pages",
	'SIGN.PAGES.CUST.LABEL'			=> 'Pages',
	'SIGN.PAGES.CUST.PLACEHOLDER'	=> 'Example: 1 or 6,7',
	'SIGN.PAGES.CUST.INVALID'		=> 'Indicate the page numbers',
