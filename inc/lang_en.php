...
$tr =[
	...
	'META.KEYWORDS'			=> 'sign, pdf, free, document, signature, image, text, creation, pages, freely, smartphones, mobile, phones, tablets',
	'META.DESCRIPTION'		=> "Sign a PDF for free. You can freely send your documents and then choose a source for your signatures between a signature created previously, an image created graphically, an image stored on your device or an image created from a text. You can choose the pages on which the signature should be added. Once the signature is created, you can easily move and resize it. The site is fully compatible with mobile phones and tablets.",
	'BACK'					=> 'Back',
	...
	'SIGNED'				=> 'Signed',
	'UNSIGNED'				=> 'Unsigned',
	'UNEXPECTED_ERROR'		=> 'An expected error has occured',
	...
	'UPLOAD.PREPARING_DOC'	=> 'Preparing the pages',
	...
	'DOCS.SIGN_DOC.PREPARING'		=> 'Preparing the pages',
	'DOCS.SIGN.INVALID_PAGE_INDEX'	=> 'Invalid page number',
	'DOCS.NAV_PAGE.FIRST_PAGE'		=> 'First page',
	'DOCS.NAV_PAGE.PREV_PAGE'		=> 'Previous page',
	'DOCS.NAV_PAGE.NEXT_PAGE'		=> 'Next page',
	'DOCS.NAV_PAGE.LAST_PAGE'		=> 'Last page',
	'DOCS.NAV_PAGE.ROTATE_LEFT'		=> 'Rotate left',
	'DOCS.NAV_PAGE.ROTATE_RIGHT'	=> 'Rotate right',
	'SIGNS.LIST_SIGNS'				=> 'Here is the list of your signatures created previously',
	'SIGNS.DELETE.CONFIRM'			=> 'Are you sure you want to remove this signature ?',
	...
	'SIGN.OPTIONS.CREA.THICK.LABEL'	=> 'Line thickness',
	'SIGN.OPTIONS.CREA.COLOR.LABEL'	=> 'Color',
	...
	'SIGN.OPTIONS.TEXT.INVITE'		=> 'An image created from a text',
	'SIGN.OPTIONS.TEXT.LABEL'		=> 'Text',
	'SIGN.OPTIONS.TEXT.PLACEHOLDER'	=> 'Your signature text',
	'SIGN.OPTIONS.TEXT.INVALID'		=> 'Enter a text',
	'SIGN.OPTIONS.TEXT.FONT.LABEL'	=> 'Font',
	'SIGN.OPTIONS.TEXT.COLOR.LABEL'	=> 'Color',
	'SIGN.OPTIONS.PREV.INVITE'		=> "A signature created previously",
	...
	'SIGN.PAGES.CURR.INVITE'		=> 'The current page',
	...
	'ACCOUNT.USER_OPTIN'			=> "I accept to receive information messages from this site",
